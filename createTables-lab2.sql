...
CREATE TABLE Department(deptID INT,deptName VARCHAR(100),location VARCHAR(100), PRIMARY KEY (deptID));

DROP TABLE IF EXISTS Employee;
CREATE TABLE Employee(empID INT,empName VARCHAR(100),job VARCHAR(100),deptID INT,salary INT, PRIMARY KEY(empID));

DROP TABLE IF EXISTS Assigned;
CREATE TABLE Assigned(empID INT,projID INT,role VARCHAR(100), PRIMARY KEY(empID));
